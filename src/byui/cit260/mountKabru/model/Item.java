...
public enum Item implements Serializable{
    ...
    club("Stick", "A scary looking Stick",30,0,600,500,0,0),
    dagger("Dagger","A scary looking Stick",40,0,1000,700,0,0),
    mace("Stick", "A scary looking Stick",50,0,1500,1000,0,0),
    shortSword("Stick", "A scary looking Stick",60,0,2000,1300,0,0),
    ...
    longSword("Stick", "A scary looking Stick",100,0,4000,3000,0,0),
    claymore("Claymore","large and in Charge", 110,0,5000,3800,0,0),
    battleAxe("battleAxe","This thing is sharp enough to kill you just looking at it", 120,0,6000,4500,0,0),
    ...
    thickGarment("Thick Garment","Plain, simple, and comfortable clothes", 0,10,300,200,0,0),
    leatherArmor("leatherArmor","light weight, sturdy, and smells good, what more could you want?",0,20,600,500,0,0),
    studdedLeatherArmor("Studded Leather Armor","Plain, simple, and comfortable clothes", 0,30,1000,700,0,0),
    chainMail("Chain Mail","Plain, simple, and comfortable clothes", 0,40,1500,1000,0,0),
    breastPlate("clothes","Plain, simple, and comfortable clothes", 0,50,2000,1300,0,0),
    cuirasses("clothes","Plain, simple, and comfortable clothes", 0,60,2500,1800,0,0),
    scaleMail("scaleMail","A little more protection for not a bad price",0,70,3000,2300,0,0),
    steelHalfPlate("clothes","Plain, simple, and comfortable clothes", 0,80,3500,2800,0,0),
    steelFullPlate("clothes","Plain, simple, and comfortable clothes", 0,90,4000,3000,0,0),
    carbonFiber("carbonFiber","strong and light weight, also makes you look like batman",0,100,5000,3800,0,0),
    diamondHalfPlate("clothes","Plain, simple, and comfortable clothes", 0,110,6000,4500,0,0),
    diamondFullPlate("clothes","Plain, simple, and comfortable clothes", 0,120,7000,5200,0,0),
    dragonBoneArmor("dragonBoneArmor","By far the best armor on the market, just dont let smog see you wearing it",0,130,8000,6000,0,0),
